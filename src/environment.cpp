...
void cityBlock(pcl::visualization::PCLVisualizer::Ptr& viewer, ProcessPointClouds<pcl::PointXYZI> pointProcessor, const pcl::PointCloud<pcl::PointXYZI>::Ptr& inputCloud)
{
    ...
    pcl::PointCloud<pcl::PointXYZI>::Ptr filter_cloud = pointProcessor.FilterCloud(inputCloud,0.2,Eigen::Vector4f (-10, -5,-3 , 1), Eigen::Vector4f ( 30, 7, 3, 1));
    std::pair<pcl::PointCloud<pcl::PointXYZI>::Ptr, pcl::PointCloud<pcl::PointXYZI>::Ptr> segmentCloud = pointProcessor.SegmentPlane(filter_cloud, 100, 0.2);
    std::vector<pcl::PointCloud<pcl::PointXYZI>::Ptr> cloudClusters = pointProcessor.Clustering(segmentCloud.second, 0.5, 30, 500);
