...
void euclideanClusterHelper(int i, std::vector<int>& cluster, const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol, std::vector<bool>& processed)
{
		...
		{
			if(!processed[id])
				euclideanClusterHelper(id,cluster,points,tree,distanceTol,processed);
		}
...
std::vector<std::vector<int>> euclideanCluster(const std::vector<std::vector<float>>& points, KdTree* tree, float distanceTol)
{
	...
	while(i<points.size())
	{
		...
		euclideanClusterHelper(i,cluster,points,tree,distanceTol, processed);
